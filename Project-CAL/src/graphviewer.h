...
/** \brief Standard Class to hold the Window generated to vizualize the Network.*/
class GraphViewer {
public:
	/**
	 * \brief Variável que guarda a próxima porta que o programa vai usar. O valor inicial é 7772.
	 */
	static short port;

	/**
	 * \brief Construtor que cria um novo grafo e atribui automaticamente a porta.
	 * \details Exemplo: GraphViewer *gv = new GraphViewer(600, 600, true); instancia um grafo
	...
	/**
	 * \brief Construtor que cria um novo grafo, utilizando uma porta especificada pelo utilizador para a ligação.
	 *
	 * \details Exemplo: GraphViewer *gv = new GraphViewer(600, 600, false, 3000); instancia um grafo
	 * 600x600, onde a posição dos nós é determinada pelo utilizador
	 * \details (usando a versão de addNode onde se pode especificar as coordenadas), sendo que a porta
	...
	/**
	 * \brief Função que cria a janela para visualização.
	 * \details Exemplo, para um apontador gv onde foi instanciada a classe GraphViewer:
	...
	/**
	 * \brief Fecha a janela a ser utilizada para visualização.
	 */
	bool closeWindow();

	/**
	 * \brief Acrescenta um nó à representação do grafo, numa posição específica, irrelevante se o grafo
	 * for dinâmico.
	 * \details Exemplo, para um apontador gv onde foi instanciada a classe GraphViewer com isDynamic = false:
	...
	/**
	 * \brief Acrescenta um nó à representação do grafo, numa posição ao critério do programa.
	 * \details Só pode ser usado se o grafo for dinâmico, ou seja, se as posições de todos
	 * os nós forem atribuídas automaticamente. Caso contrário, não adiciona o nó.
	 * \details Exemplo, para um apontador gv onde foi instanciada a classe GraphViewer com isDynamic = true:
	...
	/**
	 * \brief Acrescenta uma aresta à representação do grafo.
	 * \details Exemplo, para um apontador gv onde foi instanciada a classe GraphViewer:
	...
	/**
	 * \brief Remove um nó da representação do grafo e todas as arestas ligadas a este.
	 * \details Exemplo, para um apontador gv onde foi instanciada a classe GraphViewer:
	...
	/**
	 * \brief Remove uma aresta da representação do grafo.
	 * \details Exemplo, para um apontador gv onde foi instanciada a classe GraphViewer:
	...
	/**
	 * \brief Função que define o texto de um nó.
	 * \details Exemplo, para um apontador gv onde foi instanciada a classe GraphViewer:
	...
	/**
	 * \brief Função que define o texto de uma aresta.
	 * \details Exemplo, para um apontador gv onde foi instanciada a classe GraphViewer:
	...
	/**
	 * \brief Função que define a cor de uma aresta.
	 * \details Exemplo, para um apontador gv onde foi instanciada a classe GraphViewer:
	...
	/**
	 * \brief Função que define se uma aresta é desenhada, ou não, a tracejado.
	 * \details Exemplo, para um apontador gv onde foi instanciada a classe GraphViewer:
	...
	/**
	 * \brief Função que define a cor de um nó.
	 * \details Exemplo, para um apontador gv onde foi instanciada a classe GraphViewer:
	...
	/**
	 * \brief Função que define o tamanho de um nó.
	 * \details Exemplo, para um apontador gv onde foi instanciada a classe GraphViewer:
	...
	/**
	 * \brief Função que define um ícone para um nó.
	 * \details Exemplo, para um apontador gv onde foi instanciada a classe GraphViewer:
	...
	/**
	 * \brief Função que define a espessura de uma aresta.
	 * \details Exemplo, para um apontador gv onde foi instanciada a classe GraphViewer:
	...
	/**
	 * \brief Função que define o peso de uma aresta na representação do grafo, a ser visualizado
	...
	/**
	 * \brief Função que define o fluxo de uma aresta na representação do grafo, a ser visualizado
	...
	/**
	 * \brief Função que define se as arestas do grafo serão desenhadas como curvas ou retas.
	 * \details Exemplo, para um apontador gv onde foi instanciada a classe GraphViewer:
	...
	/**
	 * \brief Função que define a cor global das arestas.
	 * \details Exemplo, para um apontador gv onde foi instanciada a classe GraphViewer:
	...
	/**
	 * \brief Função que define globalmente se as arestas são desenhadas, ou não, a tracejado.
	 * \details Exemplo, para um apontador gv onde foi instanciada a classe GraphViewer:
	...
	/**
	 * \brief Função que define a cor global dos nós.
	 * \details Exemplo, para um apontador gv onde foi instanciada a classe GraphViewer:
	...
	/**
	 * \brief Função que define o tamanho global dos nós.
	 * \details Exemplo, para um apontador gv onde foi instanciada a classe GraphViewer:
	...
	/**
	 * \brief Função que altera a imagem de fundo do grafo.
	 * \details Exemplo, para um apontador gv onde foi instanciada a classe GraphViewer:
	...
	/**
	 * \brief Função que actualiza a visualização do grafo.
	 */
	bool rearrange();
